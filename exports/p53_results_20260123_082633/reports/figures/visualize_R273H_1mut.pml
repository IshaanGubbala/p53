...
select rescue, resi 189
show sticks, rescue
color green, rescue
label resi 189 and name CA, 'Rescue 1: A189S'

# Show nearby residues for context
select nearby, (resi 273 around 8) or (resi 189 around 8)
...
# Save image
png /Users/ishaangubbala/Documents/p53/reports/figures/structure_R273H_1mut.png, width=1200, height=1200, dpi=300, ray=1
