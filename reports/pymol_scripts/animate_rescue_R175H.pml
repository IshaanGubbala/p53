...
load /Users/ishaangubbala/Documents/p53/Data/processed/modeled_structures/R175H/cancer_build/R175H_cancer.pdb, cancer_mutant
...
select dna_contact, wildtype and (resi 175 or resi 241 or resi 248 or resi 273 or resi 280)
...
select cancer_site, cancer_mutant and resi 175
show spheres, cancer_site
color red, cancer_site
set sphere_scale, 1.8, cancer_site

# Show disrupted DNA binding interface
select mutant_interface, cancer_mutant and (resi 175 or resi 241 or resi 248 or resi 273 or resi 280)
...
label label_mutant, 'CANCER MUTANT (R175H): Destabilized, Poor DNA Binding'
...
select rescued_cancer_site, rescued and resi 175
show spheres, rescued_cancer_site
color salmon, rescued_cancer_site
set sphere_scale, 1.6, rescued_cancer_site
label rescued_cancer_site and name CA, 'R175H'

# Show RESTORED DNA binding interface
select rescued_interface, rescued and (resi 175 or resi 241 or resi 248 or resi 273 or resi 280)
...
mpng /Users/ishaangubbala/Documents/p53/reports/figures/animations/frames/rescue_animation_R175H_

print('Frames rendered! Use ffmpeg to create video:')
print('cd /Users/ishaangubbala/Documents/p53/reports/figures/animations')
print('ffmpeg -framerate 30 -i frames/rescue_animation_R175H_%04d.png -c:v libx264 -pix_fmt yuv420p rescue_animation_R175H.mp4')
