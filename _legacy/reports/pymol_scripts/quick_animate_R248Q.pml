...
label label2, 'CANCER MUTANT (R248Q)'
set label_color, red
...
set cache_frames, 0
mpng /Users/ishaangubbala/Documents/p53/reports/figures/animations/frames/quick_rescue_R248Q_
...
print('ffmpeg -framerate 30 -i frames/quick_rescue_R248Q_%04d.png -vf scale=1280:720 -c:v libx264 -pix_fmt yuv420p quick_rescue_R248Q.mp4')
print('='*60)