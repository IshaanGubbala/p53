...
set cache_frames, 0
mpng /Users/ishaangubbala/Documents/p53/reports/figures/animations/frames/R248Q_cancer_binding_

print('='*60)
print('Frames rendered!')
print('Create video:')
print('cd /Users/ishaangubbala/Documents/p53/reports/figures/animations')
print('ffmpeg -framerate 30 -i frames/R248Q_cancer_binding_%04d.png -c:v libx264 -pix_fmt yuv420p R248Q_cancer_binding.mp4')
print('='*60)