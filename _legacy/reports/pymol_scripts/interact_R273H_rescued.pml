...
# Load structures
load /Users/ishaangubbala/Documents/p53/Data/processed/modeled_structures/R273H/rescue_build/R273H_rescued.pdb, protein
...
set cache_frames, 0
mpng /Users/ishaangubbala/Documents/p53/reports/figures/animations/frames/R273H_rescued_binding_

print('='*60)
print('Frames rendered!')
print('Create video:')
print('cd /Users/ishaangubbala/Documents/p53/reports/figures/animations')
print('ffmpeg -framerate 30 -i frames/R273H_rescued_binding_%04d.png -c:v libx264 -pix_fmt yuv420p R273H_rescued_binding.mp4')
print('='*60)