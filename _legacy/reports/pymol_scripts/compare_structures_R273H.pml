...
load /Users/ishaangubbala/Documents/p53/Data/processed/modeled_structures/R273H/wild_type.pdb, wt
...
select wt_future_mut, wt and resi 273
...
select wt_region, wt and (resi 273 around 8)
...
select cancer_mut, cancer and resi 273
show spheres, cancer_mut
color red, cancer_mut
set sphere_scale, 1.8, cancer_mut
label cancer_mut and name CA, 'R273H (R→H)'

# Show destabilized region (red surface)
select cancer_destab, cancer and (resi 273 around 8)
...
select cancer_distorted, cancer and (resi 273+268+269+270+271+272+273+274+275+276+277+278)
...
ray 3600, 1200
png /Users/ishaangubbala/Documents/p53/reports/figures/structural_comparisons/R273H_structural_comparison.png, dpi=300

print('='*60)
print('Image saved: /Users/ishaangubbala/Documents/p53/reports/figures/structural_comparisons/R273H_structural_comparison.png')
print('='*60)