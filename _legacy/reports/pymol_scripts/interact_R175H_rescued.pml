...
set cache_frames, 0
mpng /Users/ishaangubbala/Documents/p53/reports/figures/animations/frames/R175H_rescued_binding_

print('='*60)
print('Frames rendered!')
print('Create video:')
print('cd /Users/ishaangubbala/Documents/p53/reports/figures/animations')
print('ffmpeg -framerate 30 -i frames/R175H_rescued_binding_%04d.png -c:v libx264 -pix_fmt yuv420p R175H_rescued_binding.mp4')
print('='*60)